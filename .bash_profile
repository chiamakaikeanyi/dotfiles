...
alias ga="git add . "
# Git commit "title" and "description" are nothing more than just the first line, and the rest of the lines in the commit message, usually separated by a blank line, by convention. Adding \n\n to the message creates the commit description e.g. git commit -m "Commit title\n\nCommit description"
